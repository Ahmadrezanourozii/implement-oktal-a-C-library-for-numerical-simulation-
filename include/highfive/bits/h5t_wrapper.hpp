...
inline herr_t h5t_reclaim(hid_t type_id, hid_t space_id, hid_t plist_id,
                          void *buf) {
...
inline herr_t h5t_set_fields(hid_t type_id, size_t spos, size_t epos,
...
inline herr_t h5t_insert(hid_t parent_id, const char *name, size_t offset,
                         hid_t member_id) {
...
inline herr_t h5t_commit2(hid_t loc_id, const char *name, hid_t type_id,
