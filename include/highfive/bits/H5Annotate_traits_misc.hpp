...
AnnotateTraits<Derivate>::createAttribute(const std::string &attribute_name,
  ...
  auto attr_id = detail::h5a_create2(static_cast<Derivate *>(this)->getId(),
                                     attribute_name.c_str(), dtype.getId(),
...
AnnotateTraits<Derivate>::createAttribute(const std::string &attribute_name,
                                          const DataSpace &space) {
  return createAttribute(attribute_name, space,
...
AnnotateTraits<Derivate>::deleteAttribute(const std::string &attribute_name) {
  detail::h5a_delete(static_cast<const Derivate *>(this)->getId(),
...
inline Attribute AnnotateTraits<Derivate>::getAttribute(
  ...
  const auto attr_id =
      detail::h5a_open(static_cast<const Derivate *>(this)->getId(),
...
inline size_t AnnotateTraits<Derivate>::getNumberAttributes() const {
  int res =
      detail::h5a_get_num_attrs(static_cast<const Derivate *>(this)->getId());
...
AnnotateTraits<Derivate>::listAttributeNames() const {
  ...
  detail::h5a_iterate2(static_cast<const Derivate *>(this)->getId(),
                       H5_INDEX_NAME, H5_ITER_INC, nullptr,
...
AnnotateTraits<Derivate>::hasAttribute(const std::string &attr_name) const {
  return detail::h5a_exists(static_cast<const Derivate *>(this)->getId(),
                            attr_name.c_str()) > 0;
}
