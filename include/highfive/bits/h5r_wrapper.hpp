...
namespace HighFive {
namespace detail {
inline herr_t h5r_create(void *ref, hid_t loc_id, const char *name,
...
inline hid_t h5r_dereference(hid_t obj_id, hid_t oapl_id, H5R_type_t ref_type,
                             const void *ref) {
...
#else
inline hid_t h5r_dereference(hid_t dataset, H5R_type_t ref_type,
                             const void *ref) {
