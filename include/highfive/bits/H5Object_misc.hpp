...
inline Object::Object(Object &&other) noexcept : _hid(other._hid) {
...
inline hid_t Object::getId() const noexcept { return _hid; }
...
inline haddr_t ObjectInfo::getAddress() const noexcept { return raw_info.addr; }
inline size_t ObjectInfo::getRefCount() const noexcept { return raw_info.rc; }
