...
inline unsigned Compression::get() const { return m_compression_level; }

inline void DumpOptions::set(DumpMode mode) {
  m_overwrite = static_cast<bool>(mode);
}

inline void DumpOptions::set(Flush mode) { m_flush = static_cast<bool>(mode); }
...
inline bool DumpOptions::overwrite() const { return m_overwrite; }

inline bool DumpOptions::flush() const { return m_flush; }

inline bool DumpOptions::compress() const { return m_compression_level > 0; }

inline unsigned DumpOptions::getCompressionLevel() const {
  return m_compression_level;
}

inline bool DumpOptions::isChunked() const { return m_chunk_size.size() > 0; }
...
inline Attribute dumpAttribute(File &file, const std::string &path,
                               ...
                               DumpMode mode) {
  return detail::io_impl<T>::dumpAttribute(file, path, key, data,
                                           DumpOptions(mode));
}
