...
///
/// WARNING: Creating an Group from an ID has implications w.r.t. the lifetime
/// of the object
...
Group::getEstimatedLinkInfo() const {
...
namespace detail {
inline Group make_group(hid_t hid) { return Group(hid); }
} // namespace detail
