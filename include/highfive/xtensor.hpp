...
template <class XTensor> struct xtensor_get_rank;
...
struct xtensor_inspector_base {
  ...
  static constexpr bool is_trivially_copyable =
      IsConstExprRowMajor && std::is_trivially_copyable<value_type>::value &&
...
struct xtensor_inspector
    : public xtensor_inspector_base<xtensor_inspector<XTensorType, L>,
                                    XTensorType, L> {
private:
  using super =
      xtensor_inspector_base<xtensor_inspector<XTensorType, L>, XTensorType, L>;
...
public:
  ...
  static std::array<size_t, ndim>
  shapeFromDims(const std::vector<size_t> &dims) {
...
struct xarray_inspector
    : public xtensor_inspector_base<xarray_inspector<XArrayType, L>, XArrayType,
                                    L> {
private:
  using super =
      xtensor_inspector_base<xarray_inspector<XArrayType, L>, XArrayType, L>;
...
template <typename T, size_t N, xt::layout_type L>
struct inspector<xt::xtensor<T, N, L>>
    : public xtensor_inspector<xt::xtensor<T, N, L>, L> {
private:
...
struct inspector<xt::xarray<T, L>>
    : public xarray_inspector<xt::xarray<T, L>, L> {
private:
...
struct inspector<xt::xarray_adaptor<EC, L, SC, Tag>>
    : public xarray_inspector<xt::xarray_adaptor<EC, L, SC, Tag>,
                              xt::layout_type::any> {
private:
  using super = xarray_inspector<xt::xarray_adaptor<EC, L, SC, Tag>,
                                 xt::layout_type::any>;
...
struct inspector<xt::xtensor_adaptor<EC, N, L, Tag>>
    : public xtensor_inspector<xt::xtensor_adaptor<EC, N, L, Tag>,
                               xt::layout_type::any> {
private:
  using super = xtensor_inspector<xt::xtensor_adaptor<EC, N, L, Tag>,
                                  xt::layout_type::any>;
